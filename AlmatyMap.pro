...
unrealRootPath=/home/magzhan/WorkspaceGraphics/UnrealEngine
AlmatyMapRootPath=/home/magzhan/WorkspaceGraphics/UnrealProjects/AlmatyMap

gameProjectFile=/home/magzhan/WorkspaceGraphics/UnrealProjects/AlmatyMap/AlmatyMap.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(AlmatyMapSource.pri)
include(AlmatyMapHeader.pri)
include(AlmatyMapConfig.pri)
include(AlmatyMapIncludes.pri)
include(AlmatyMapDefines.pri)
...
AlmatyMap-Linux-Debug.commands = $$build AlmatyMap Linux Debug  -project="\"$$gameProjectFile\"" $$args
AlmatyMap-Linux-DebugGame.commands = $$build AlmatyMap Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
AlmatyMap-Linux-Shipping.commands = $$build AlmatyMap Linux Shipping  -project="\"$$gameProjectFile\"" $$args
AlmatyMap-Linux-Test.commands = $$build AlmatyMap Linux Test  -project="\"$$gameProjectFile\"" $$args
AlmatyMap.commands = $$build AlmatyMap Linux Development  -project="\"$$gameProjectFile\"" $$args

AlmatyMapEditor-Linux-Debug.commands = $$build AlmatyMapEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
AlmatyMapEditor-Linux-DebugGame.commands = $$build AlmatyMapEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
AlmatyMapEditor-Linux-Shipping.commands = $$build AlmatyMapEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
AlmatyMapEditor-Linux-Test.commands = $$build AlmatyMapEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
AlmatyMapEditor.commands = $$build AlmatyMapEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	AlmatyMap-Linux-Debug \
	AlmatyMap-Linux-DebugGame \
	AlmatyMap-Linux-Shipping \
	AlmatyMap-Linux-Test \
	AlmatyMap \
	AlmatyMapEditor-Linux-Debug \
	AlmatyMapEditor-Linux-DebugGame \
	AlmatyMapEditor-Linux-Shipping \
	AlmatyMapEditor-Linux-Test \
	AlmatyMapEditor \
