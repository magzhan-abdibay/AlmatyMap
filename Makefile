...
AlmatyMap-Linux-Debug:
	 $(PROJECTBUILD) AlmatyMap Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlmatyMap-Linux-DebugGame:
	 $(PROJECTBUILD) AlmatyMap Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlmatyMap-Linux-Shipping:
	 $(PROJECTBUILD) AlmatyMap Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlmatyMap-Linux-Test:
	 $(PROJECTBUILD) AlmatyMap Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlmatyMap:
	 $(PROJECTBUILD) AlmatyMap Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlmatyMapEditor-Linux-Debug:
	 $(PROJECTBUILD) AlmatyMapEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlmatyMapEditor-Linux-DebugGame:
	 $(PROJECTBUILD) AlmatyMapEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlmatyMapEditor-Linux-Shipping:
	 $(PROJECTBUILD) AlmatyMapEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlmatyMapEditor-Linux-Test:
	 $(PROJECTBUILD) AlmatyMapEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

AlmatyMapEditor:
	 $(PROJECTBUILD) AlmatyMapEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
